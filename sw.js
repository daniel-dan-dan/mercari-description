...
const CACHE_NAME = 'mercari-description-v20260920c';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920c',
  './public-config.js?v=20260920c',
  './catalog-data.js?v=20260920c',
  './app.js?v=20260920c',
  './review.js?v=20260920c',
  './bootstrap.js?v=20260920c',
  './pair.js?v=20260920c',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
