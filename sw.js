...
const CACHE_NAME = 'mercari-description-v20260919c';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260919c',
  './public-config.js?v=20260919c',
  './catalog-data.js?v=20260919c',
  './app.js?v=20260919c',
  './review.js?v=20260919c',
  './sale-comments.js?v=20260919c',
  './bootstrap.js?v=20260919c',
  './pair.js?v=20260919c',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
