...
const CACHE_NAME = 'mercari-description-v20260920i';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920i',
  './public-config.js?v=20260920i',
  './catalog-data.js?v=20260920i',
  './app.js?v=20260920i',
  './review.js?v=20260920i',
  './bootstrap.js?v=20260920i',
  './pair.js?v=20260920i',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
