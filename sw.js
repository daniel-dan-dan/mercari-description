...
const CACHE_NAME = 'mercari-description-v20260920j';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920j',
  './public-config.js?v=20260920j',
  './catalog-data.js?v=20260920j',
  './app.js?v=20260920j',
  './review.js?v=20260920j',
  './bootstrap.js?v=20260920j',
  './pair.js?v=20260920j',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
