...
const CACHE_NAME = 'mercari-description-v20260920a';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920a',
  './public-config.js?v=20260920a',
  './catalog-data.js?v=20260920a',
  './app.js?v=20260920a',
  './review.js?v=20260920a',
  './sale-comments.js?v=20260920a',
  './bootstrap.js?v=20260920a',
  './pair.js?v=20260920a',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
