...
const CACHE_NAME = 'mercari-description-v20260920h';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920h',
  './public-config.js?v=20260920h',
  './catalog-data.js?v=20260920h',
  './app.js?v=20260920h',
  './review.js?v=20260920h',
  './bootstrap.js?v=20260920h',
  './pair.js?v=20260920h',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
