...
const CACHE_NAME = 'mercari-description-v20260911a';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260911a',
  './public-config.js?v=20260911a',
  './catalog-data.js?v=20260911a',
  './app.js?v=20260911a',
  './review.js?v=20260911a',
  './bootstrap.js?v=20260911a',
  './pair.js?v=20260911a',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
