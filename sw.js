...
const CACHE_NAME = 'mercari-description-v20260920b';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920b',
  './public-config.js?v=20260920b',
  './catalog-data.js?v=20260920b',
  './app.js?v=20260920b',
  './review.js?v=20260920b',
  './bootstrap.js?v=20260920b',
  './pair.js?v=20260920b',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
