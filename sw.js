...
const CACHE_NAME = 'mercari-description-v20260920d';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920d',
  './public-config.js?v=20260920d',
  './catalog-data.js?v=20260920d',
  './app.js?v=20260920d',
  './review.js?v=20260920d',
  './bootstrap.js?v=20260920d',
  './pair.js?v=20260920d',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
