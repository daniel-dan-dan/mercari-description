...
const CACHE_NAME = 'mercari-description-v20260920e';
const ASSETS = [
  './',
  './index.html',
  './pair.html',
  './styles.css?v=20260920e',
  './public-config.js?v=20260920e',
  './catalog-data.js?v=20260920e',
  './app.js?v=20260920e',
  './review.js?v=20260920e',
  './bootstrap.js?v=20260920e',
  './pair.js?v=20260920e',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
