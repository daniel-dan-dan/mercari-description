...
assert.match(serviceWorker, /mercari-description-v20260907a/);
assert.match(serviceWorker, /styles\.css\?v=20260907a/);
assert.match(serviceWorker, /catalog-data\.js\?v=20260907a/);
assert.match(serviceWorker, /app\.js\?v=20260907a/);
