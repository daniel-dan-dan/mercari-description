...
assert.match(indexHtml, /v20260920h \/ UI改善・セキュリティ強化/);
assert.match(indexHtml, /catalog-data\.js\?v=20260920h/);
assert.match(indexHtml, /app\.js\?v=20260920h/);

const serviceWorker = fs.readFileSync('sw.js', 'utf8');
assert.match(serviceWorker, /mercari-description-v20260920h/);
